...
replace (
	...
	github.com/k3s-io/helm-controller => github.com/aiyengar2/helm-controller v0.0.0-20220407164711-2314e4c9835c
...
require (
	github.com/aiyengar2/helm-locker v0.0.0-20220407142808-da1cab89976f
